...
def plot_input_layer_with_membrane_potential(indices, times, network, duration, \
    ...
    ax1.set_ylabel("generator neurons", labelpad=25, fontsize=14)
    ...
    ax2.set_ylabel("input neurons", labelpad=40, fontsize=14)
    ...
    ax3.set_ylabel("membrane potential", labelpad=25, fontsize=14)
...
def plot_currents_distributions(network, figsize=(6, 4), directory=None):
    ...
    """
    fig = plt.figure(figsize=figsize)
    grid = grs.GridSpec(1, 4, wspace=0.3, hspace=0.0)
    ax1 = plt.Subplot(fig, grid[0])
    ax1.hist(network['gRes'].Itau/pA)
    ax1.set_xlabel("Itau [pA]", fontsize=18)
    ax1.set_ylabel("counts", fontsize=18)
    ax1.set_yscale("log")
    ax2 = plt.Subplot(fig, grid[1], sharey=ax1)
    ax2.hist(network['gRes'].Ispkthr/pA)
    ax2.set_xlabel("Ispkthr [pA]", fontsize=18)
    ax2.set_yscale("log")
    ax3 = plt.Subplot(fig, grid[2])
    ax3.hist(network['sResRes'].Ie_tau/pA)
    ax3.set_xlabel("Ie_tau [pA]", fontsize=18)
    ax3.set_yscale("log")
    ax4 = plt.Subplot(fig, grid[3], sharey=ax2)
    ax4.hist(network['sResRes'].Ii_tau/pA)
    ax4.set_xlabel("Ii_tau [pA]", fontsize=18)
    ax4.set_yscale("log")
    fig.add_subplot(ax1)
    fig.add_subplot(ax2)
    fig.add_subplot(ax3)
